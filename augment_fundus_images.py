...
from dataset_split import val_names  # List of validation image filenames to exclude
...
if __name__ == '__main__':
    input_directory = 'csdi/processed_data/croped_images'
    output_directory = 'csdi/processed_data/croped_augmented_images'
