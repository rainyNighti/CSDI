...
def main():
    ...
    parser.add_argument('-i', '--input_dir', help="Input directory containing original images.", default="original_images")
    parser.add_argument('-o', '--output_dir', help="Output directory for saving cropped images.", default="csdi/processed_data/croped_images")
    parser.add_argument('-p', '--padding', type=int, default=0, help="Extra pixel padding around the crop boundary, default 0.")
    parser.add_argument('-c', '--csv_path', type=str, default="csdi/processed_data/crop_info.csv", help="CSV file path to save cropping information, default 'crop_info.csv'.")
